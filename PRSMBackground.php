...
<svg class="shape" viewBox="0 0 100 115" preserveAspectRatio="xMidYMin slice">
    ...
    <polygon points="" fill="none" stroke="hsl(0,10%,50%,0.5)" stroke-width="5">
    ...
    <polygon points="" fill="none" stroke="hsl(45,100%,45%, 0.5)" stroke-width="5">
    ...
    <polygon points="" fill="none" stroke="hsl(0,10%,20%, 0.5)" stroke-width="5">
